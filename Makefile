...
migration-up:
	migrate -path ./migrations/postgres -database 'postgres://postgres:admin1234@localhost:5432/ucode_go_company_service?sslmode=disable' up

migration-down:
	migrate -path ./migrations/postgres -database 'postgres://postgres:admin1234@localhost:5432/ucode_go_company_service?sslmode=disable' down
